...
> **Crafting interactive experiences and lightweight desktop utilities.**  
> Built by a robotics engineering student exploring the intersection of code, logic, and play.
...
* 🎮 **Zijeossi: Lazy Awakened Hero** (`v2.0.0`)
  ...
  * *Status*: Playable Alpha / Web Demo (Targeting itch.io & CrazyGames) 
...
* **Core Languages:** `JavaScript (ES6+)` `Python` `C#` `C++` `HTML5 / CSS3`
* **Game & Graphics:** `HTML5 Canvas 2D` `Web Audio API` `Unity` `Godot` `Procedural Rendering`
...
🌐 **Website:** [959labs.github.io](https://959labs.github.io)  
✉️ **Contact:** 959labs@gmail.com
